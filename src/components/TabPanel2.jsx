...
//       <div className="border-b border-gray-700 m-4 md:m-10"></div>
...
//       </p>
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-between gap-4 h-auto lg:h-[25rem] w-[25%]">
...
const TabPanel2 = () => {
  return (
    <div className="bg-black text-white p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 h-auto lg:h-[25rem]">
        {creators.map((creator) => (
          <div
            key={creator.id}
            className="relative bg-gray-800 rounded-lg shadow-lg w-full group"
          >
            <img
              src={creator.image}
              alt={creator.title}
